...
::: callout-important
This section was prepared based on the old data set it is going to be updated soon.
:::
...
*Column 8* has three different field values: \* Consumers : Indicates the individual partakes in regular alcohol consumption. \* Doesn't consume : Means the individual has consumed alcohol before, but not anymore/not regularly. \* Never consume : Indicates the individual has never consumed alcohol before.
