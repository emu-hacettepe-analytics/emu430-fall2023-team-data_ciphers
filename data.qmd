...
::: {style="text-align: justify The second column, titled *usage*, has three different field values: \* Consumers : Indicates the individual partakes in regular alcohol consumption. \* Doesn't consume : Means the individual has consumed alcohol before, but not anymore/not regularly. \* Never consume : Indicates the individual has never consumed alcohol before. :::
...
::: {style="text-align: justify This data set showcases the body mass index distribution of male and female individuals, as well as a total for the year of each sub-study. The data here was collected every two years starting from 2008, and ending at 2022. :::
